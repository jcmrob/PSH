function Bxyz = jovian_jrm09_order10_internal_xyz( x_rj, y_rj, z_rj)
...
%
% Outputs:
%  B - Cartesian Magnetic field vector the JRM09_ORDER10 internal magnetic field model, [Bx, By, Bz], units of nT.
%
% Usage:
% For internal field only: B = jovian_jrm09_order10_internal_xyz(x_rj, y_rj, z_rj)
%
...
%
% Version Info:
%  Last update of this file: 2022-03-21 15:26:15.176152 by user wilsonr. 
%  This code was re-written/re-formatted by Rob's python code:
%   /Users/wilsonr/Documents/JADE/Level2_Processing_Code/IDL/Field_Model/2022/MOP_spherical.py
%   which itself was last updated at UTC 2022-03-21T21:26:13.
%
...
g = [  ... % Matlab starts at index 1, not 0, so no value on this first line compared to IDL & Python output
          ...
          -110265.51694787663291208446026 ,        -12861.08441189933364512398839 ,        -25680.06972210412277490831912 ,         -1835.99981426163253672712017 , ...
           ...
           488932.02253022126387804746628 ,        448310.26802277535898610949516 ,        578200.21502919984050095081329 ,        346825.93308208207599818706512 , ...
             ...
             1525.17384009177953885227907 ,           771.06330156869501024630154 ];
...
h = [  ... % Matlab starts at index 1, not 0, so no value on this first line compared to IDL & Python output
         ...
         -1141644.22994741331785917282104 ,        936694.13928736466914415359497 ,       -393135.81781678373226895928383 ,       -257618.41363149805692955851555 , ...
            ...
            -1896.31274843787309691833798 ,           995.21720307946509365137899 ];
