...
def jovian_vip4_order04_internal_xyz( x_rj, y_rj, z_rj):
    ...
    #
    # Outputs:
    #  B - Cartesian Magnetic field vector the VIP4_ORDER04 internal magnetic field model, [Bx, By, Bz], units of nT.
    #
    # Usage:
    # For internal field only: B = jovian_vip4_order04_internal_xyz(x_rj, y_rj, z_rj)
    #
    ...
    #
    # Version Info:
    #  Last update of this file: 2022-03-21 15:26:15.189818 by user wilsonr. 
    ...
    r_scale = np.float64(71492.000000)/np.float64(71323.000000)
    x_in = x_in * r_scale
    y_in = y_in * r_scale
    z_in = z_in * r_scale
