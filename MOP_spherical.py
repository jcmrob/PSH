...
import os
from reordergh import expand_out_g_and_h
...
models_to_do = (['jrm09_order10','jrm33_order13','vip4_order04'])
...
# The above link goes to 10 degrees
  ...
  0., 20958.4,  \
  0., -42549.0, 20221.5,  \
  0., -32890.6, 42518.4, -27397.7,  \
  0., 32452.4, 27438.6, -501.4, -1325.1,  \
  0., 45363.1, -826.2, 6000.6, 10568.8, 10091.5,  \
  0., 14016.9, -10119.1, -294.9, 13948.3, -3686.9, 4783.1,  \
  0., -7654.8, -11398.6, 2171.0, 5301.6, -6618.1, -1933.8, -5802.9,  \
  0., -2297.4, -12833.5, 10019.6, -1725.6, 2387.1, -3237.1, 906.1, -3178.3,  \
  0., -7899.6, -1328.3, 6566.5, -1275.3, 3617.1, -194.8, 1960.3, 956.9, 1831.7,  \
  0., -5689.8, 5570.3, -2541.6, -1795.2, -217.8, -628.3, -1619.6, 454.6, -840.0, 1581.4,  \
  0., 549.1, 4527.6, -4223.0, -2761.9, -476.0, -2714.4, -1349.2, -1649.0, -1471.5, -583.0, -499.8,  \
  0., 4204.2, 2228.0, -1901.1, -1271.2, 1073.4, -1111.9, 872.9, -837.9, -462.8, -22.0, 110.3, -712.7,  \
  0., 4125.6, -44.0, -455.4, 2160.6, 255.4, 1105.1, 1214.2, 196.1, -207.7, 1195.7, 472.4, 721.6, 51.3,  \
  0., -847.8, -124.9, 108.8, 1456.2, -1284.6, 896.5, 237.0, 225.8, -80.9, 696.9, 326.5, 225.9, 71.0, 124.4,  \
  0., -1146.4, -580.4, 527.3, 120.0, -478.9, 148.4, 45.7, -882.5, -206.6, -74.9, 51.0, 36.4, -44.4, -285.9, 135.1,  \
  0., -932.8, -608.1, 510.2, -587.4, -39.4, 358.1, 279.8, 244.5, 487.3, 366.7, 93.9, 282.8, -267.7, 39.8, -213.1, 32.4,  \
  0., -209.2, -15.8, 54.4, 308.7, 722.0, 233.3, -82.1, 221.5, 488.6, 206.3, 176.7, 353.4, 204.8, -29.5, 12.8, -89.6, -166.6,  \
  0., 670.9, -176.1, -340.3, 37.0, 304.3, -348.8, -291.9, 165.6, 360.9, -119.0, 100.1, 26.9, 1.0, -60.2, 66.5, 277.8, 29.1, 15.3,  \
  0., 85.8, -412.1, -502.0, -425.1, -232.2, -477.0, -463.5, 73.6, -228.3, -96.8, -256.0, -228.0, 119.3, -76.9, -319.8, -284.0, 197.9, -239.6, 302.6,  \
  0., -297.6, -13.7, -118.4, 105.6, 101.9, 45.3, -213.0, 372.5, -382.8, 154.2, -290.3, 17.1, 6.7, 13.2, -49.3, -32.2, -152.8, 62.2, 8.5, 35.0,  \
  0., -155.8, 312.3, 291.1, 207.9, 165.8, 291.2, 198.8, 442.1, -104.0, 209.6, -45.0, -139.6, 229.4, -59.8, -30.0, -182.0, 162.1, 131.7, -356.9, 379.5, -318.6,  \
  0., -52.5, 180.6, 182.5, -69.5, -24.5, 93.2, 188.1, 54.5, -68.5, 93.8, -87.3, -175.3, 202.4, -49.8, -129.2, -241.1, -63.6, 68.4, 168.1, -160.0, 62.6, -117.5,  \
  0., 52.8, -2.1, -51.9, -92.9, -7.9, 21.1, 16.4, -51.3, -135.8, 56.1, -172.6, 40.8, 21.3, 19.6, -63.1, -135.9, -3.1, 55.9, -63.5, -6.3, 188.1, -119.3, 313.2,  \
  0., 59.4, -45.4, -76.0, 13.9, 26.5, 63.0, 9.1, 29.6, -7.6, 38.3, -81.6, 63.3, 40.0, 50.3, -52.5, -88.2, 99.9, 59.3, -52.2, 106.4, -62.1, 34.6, -171.1, 43.5,  \
  0., -6.2, -62.4, -17.5, 72.8, -6.1, -12.2, 28.2, -18.0, 122.4, -33.4, 24.0, 19.7, 70.6, 62.2, -60.1, -54.4, 54.0, -48.5, 45.4, 24.9, -77.3, 36.9, 4.8, 85.7, -262.0,  \
  0., 5.1, -50.8, 9.5, 33.9, -7.2, -73.0, -12.9, -48.1, 55.4, -60.8, 39.0, 46.9, 43.8, 29.2, -1.9, 5.8, 36.0, -113.8, 29.2, -22.9, -10.0, -23.4, -30.5, 66.7, 126.9, -43.3,\
  0., 23.2, 8.1, 16.8, -44.1, 6.2, -17.0, -30.2, 0.7, -45.5, -18.1, 13.2, 31.8, 20.7, -14.4, 30.7, 41.0, 23.0, -56.4, 1.6, -14.7, -16.3, -31.1, -32.5, -49.2, 79.7, -45.3, 35.8,\
  0., -9.5, 37.4, 14.0, -46.1, -2.3, 34.7, -6.7, 21.6, -33.1, 16.6, -0.5, -20.5, -3.9, -16.5, 14.5, 20.4, -14.2, 15.7, -12.9, -11.8, -42.8, -8.6, 27.4, -67.5, -2.2, -19.2, 28.9, 79.4,\
  0., -23.6, 13.4, 0.8, 9.2, -9.7, 17.2, 11.0, 4.0, 14.7, 13.9, -2.4, -28.1, -21.7, 1.6, 1.5, -9.8, -21.9, 26.9, -15.6, -12.6, -28.6, 8.0, 25.6, -11.0, -10.3, -17.9, 2.0, 5.8, 40.6,\
  0., -1.0, -10.2, -8.8, 29.1, -2.4, -10.4, 6.7, -4.9, 16.9, 2.3, -1.6, -3.2, -14.0, 8.2, 0.5, -9.8, -4.4, 6.2, -5.8, -4.7, 0.1, 10.2, -3.4, 9.9, -2.5, -11.7, -10.5, -21.5, 14.6, 38.3,\
  0.],dtype='float64')
    ...
    0, 7557, 40411, -16597, 3866],dtype='float64')
            ...
            raise SystemExit
        # Make a copy of these that I can use at the end of this script
# DELETE
#        g_orig = g.copy()
#        h_orig = h.copy()
        # Need a copy, as the g and h arrays get modified below, so aren't the same numbers by the end of the code.
